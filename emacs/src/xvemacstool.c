/*
This source will build the original sunview emacstool or the Xview xvetool.
If FSF could replace the previous emacstool.c source with this,
it would be appreciated.
In etc/Makefile, add this to the bottom (-DXVIEW make xvetool):

xvetool: emacstool.c
	$(CC) -o xvetool -g -DXVIEW ${CFLAGS} emacstool.c -lxview -lX -I$(OPENWINHOME)/include -L$(OPENWINHOME)/lib $(LOADLIBES)

$EMACS/etc/emacstool.c
*/
 ...
 * Updated 04-Oct-90, Jeff Peck: set meta-bit for Openwin/X
